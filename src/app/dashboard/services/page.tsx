...
export default async function ServicesPage() {
  ...
  const { data: services } = await admin
    .from("services")
    .select(
      "id, name, category, price_won, duration_min, description, is_active, display_order, photo_url, promotion_active, promotion_price_won, promotion_start_at, promotion_end_at",
    )
    .eq("shop_id", shop.id)
